...
export class ExamenFormComponent extends CommonFormComponent<Examen,ExamenService> implements OnInit{
  ...
  override ngOnInit() {
    ...
    //Filter, mostrar AsignaturasPadre
  ...
  //Al crear asignaturas se le asigna sus hijos
  //Si existe Asignatura Padre se agregan las hijas sino vacio []
  cargarHijos(): void{
    this.asignaturasHija= this.model.asignaturaPadre? this.model.asignaturaPadre.hijos : [];
  }

  //Comparar la asignatura si existe para editarla
  //=== significa identico, igual en tipo de dato y valor
