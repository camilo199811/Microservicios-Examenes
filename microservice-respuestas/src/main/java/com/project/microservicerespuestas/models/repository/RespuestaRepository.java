package com.project.microservicerespuestas.models.repository;
...
public interface RespuestaRepository extends MongoRepository<Respuesta,String> {
    ...
    //Consulta para ver si el examen fue respondido
    @Query("{'alumnoId': ?0}")
    ...
    //fetch, para que en una sola consulta traiga el alumno, la pregunta y el examen
